          ...
          {services.map((service) => (
            ...
            >
              ...
              <div>
                ...
                <div 
                  className="relative aspect-video w-full h-[240px] md:h-[300px] mb-8 overflow-hidden rounded-xl border border-zinc-200 dark:border-zinc-800/80 bg-black"
                ...
                >
                  ...
                  <div className="absolute top-4 right-4 z-10 glass px-4 py-1.5 rounded-full border border-white/5 text-[10px] font-bold tracking-widest uppercase text-zinc-300">
                    {service.subtitle}
                  </div>
                </div>
              ...
              >
                <button
                  ...
                  className="flex-1 py-3.5 text-center text-xs font-bold tracking-widest bg-amber-500 hover:bg-amber-600 text-white uppercase rounded-lg transition-colors duration-300 shadow-[0_4px_15px_rgba(245,158,11,0.2)] cursor-pointer"
                >
                  Book Appointment
                </button>
                <button
                  onClick={handleScrollToBooking}
                  className="px-6 py-3.5 text-center text-xs font-bold tracking-widest text-zinc-300 border border-zinc-700 hover:border-amber-500 hover:text-white uppercase rounded-lg transition-colors duration-300 bg-transparent cursor-pointer"
                >
                  Consult
                </button>
              </div>
