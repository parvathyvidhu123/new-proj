...
import { Phone, MessageCircle, Instagram, MapPin, Clock, Star, Send, CheckCircle2, Navigation, AlertCircle } from "lucide-react";
          ...
          <div className="lg:col-span-7 space-y-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                <h3 className="text-xs font-bold tracking-widest text-zinc-500 uppercase flex items-center gap-2">
                  <MapPin size={14} className="text-red-500" /> Studio Location
                </h3>
              ...
              <div className="space-y-4">
                <h3 className="text-xs font-bold tracking-widest text-zinc-500 uppercase flex items-center gap-2">
                  <Clock size={14} className="text-red-500" /> Operating Hours
                </h3>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-6 py-3 rounded-lg bg-amber-950/20 hover:bg-amber-600 border border-amber-800 text-white font-sans text-xs font-bold tracking-widest uppercase flex items-center gap-2 transition-all duration-300"
              >
            ...
            <div className="relative rounded-xl overflow-hidden border border-zinc-800/80 aspect-video w-full h-[250px] shadow-2xl group">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="absolute bottom-4 right-4 z-10 glass px-4 py-2 rounded-lg border border-white/10 flex items-center gap-2 text-xs font-bold tracking-widest uppercase text-zinc-200 hover:bg-amber-500 hover:text-white hover:border-amber-500 transition-all duration-300 shadow-lg"
              ...
              {submitted ? (
                <div className="flex flex-col items-center justify-center text-center py-12 animate-fade-in">
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 text-[10px] font-bold tracking-widest text-zinc-700 dark:text-zinc-300 border border-zinc-250 dark:border-zinc-800 hover:border-amber-500 hover:text-white rounded-full uppercase transition-all duration-300 bg-transparent cursor-pointer"
                  >
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-lg bg-white dark:bg-zinc-950/60 border border-zinc-200 dark:border-zinc-800 text-zinc-800 dark:text-zinc-200 placeholder-zinc-400 dark:placeholder-zinc-700 focus:outline-none focus:border-red-600 font-sans text-sm transition-all"
                    />
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-lg bg-white dark:bg-zinc-950/60 border border-zinc-200 dark:border-zinc-800 text-zinc-800 dark:text-zinc-200 placeholder-zinc-400 dark:placeholder-zinc-700 focus:outline-none focus:border-red-600 font-sans text-sm transition-all resize-none"
                    />
                    {errors.message && <span className="text-[9px] text-red-500">Message is required</span>}
                  </div>

                  {submitError && (
                    <div className="text-red-500 text-xs font-semibold flex items-center gap-1.5 justify-center mt-2">
                  ...
                  <button
                    ...
                    className="w-full py-3.5 text-[10px] font-bold tracking-[0.25em] bg-amber-500 hover:bg-amber-600 disabled:bg-zinc-800 disabled:text-zinc-500 disabled:cursor-not-allowed text-white uppercase rounded-lg transition-all duration-300 shadow-[0_4px_20px_rgba(245,158,11,0.15)] flex items-center justify-center gap-2 cursor-pointer group"
