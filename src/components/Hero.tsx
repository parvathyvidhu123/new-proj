    ...
    >
      ...
      <div className="relative z-20 text-center flex flex-col items-center justify-center max-w-5xl px-6 w-full">
        ...
        >
          ...
          <span 
            className="hero-logo-o relative inline-block w-[0.82em] h-[0.82em] align-middle mx-[0.02em] shrink-0"
            style={logoStyle}
          >
            {/* GSAP entrance animated inner wrapper */}
            <span className="hero-logo-wrapper block w-full h-full">
              <Image
                ...
                className="object-contain filter drop-shadow-[0_0_15px_rgba(234,179,8,0.45)] hero-logo-img"
              />
            </span>
          </span>
