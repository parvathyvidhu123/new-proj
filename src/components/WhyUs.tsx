        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="w-12 h-12 mb-6 rounded-lg bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 flex items-center justify-center relative z-10 group-hover:border-gold-accent/40 group-hover:shadow-[0_0_15px_rgba(221,177,30,0.2)] transition-all duration-500">
                {feature.icon}
              </div>
