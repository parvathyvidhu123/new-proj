            ...
            >
              ...
              >
                <button
                  ...
                  className="flex-1 py-3.5 text-center text-xs font-bold tracking-widest bg-gold-accent hover:bg-gold-accent/90 text-black uppercase rounded-lg transition-colors duration-300 shadow-[0_4px_15px_rgba(221,177,30,0.2)] cursor-pointer"
                >
                  Book Appointment
                </button>
                <button
                  onClick={handleScrollToBooking}
                  className="px-6 py-3.5 text-center text-xs font-bold tracking-widest text-zinc-300 border border-zinc-700 hover:border-gold-accent hover:text-white uppercase rounded-lg transition-colors duration-300 bg-transparent cursor-pointer"
                >
                  Consult
                </button>
              </div>
